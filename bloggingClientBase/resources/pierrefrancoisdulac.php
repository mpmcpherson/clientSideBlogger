...
$qq = "INSERT INTO logging(`UA_String` , `ipAdd`, `logTime`, `programId`) VALUES ('".$ua_string."','".$ipAdd."','".gmdate('Y-m-d H:i:s')."','".strval(3)."')";//should actually rig up a call-and-response here so each program knows its id
