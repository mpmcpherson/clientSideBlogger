...
(function () {
    ...
    var allowedImageFileTypes = function (editor) {
      var defaultImageFileTypes = 'jpeg,jpg,jpe,jfi,jfif,png,gif,bmp,webp';
      return global$5.explode(editor.getParam('image_file_types', defaultImageFileTypes, 'string'));
    };
    ...
    var isImageUrl = function (editor, url) {
      return isAbsoluteUrl(url) && exists(allowedImageFileTypes(editor), function (type) {
