...
(function () {
    ...
    var refreshGrid = function (warhouse, wire, table, rows, cols) {
      ...
      refreshRow(wire, resizableRowPositions, position, getOuter$1(table));
      ...
      refreshCol(wire, resizableColPositions, position, getOuter(table));
    };
    ...
    var get$9 = function (editor, isResizable) {
    ...
    var isResizable = function (elm) {
      return get$1(elm, 'data-mce-resize') !== 'false';
    };
    var getResizeHandler = function (editor) {
      ...
      editor.on('init', function () {
        var rawWire = get$9(editor, isResizable);
